export default {
  ...
  nav: {
    ...
    realtimeVoiceTest: 'Realtime Voice Test',
  },
  ...
  chat: {
    ...
    historySubtitle: 'Manage in-tab conversations from the left rail, similar to ChatGPT.',
    sessionCount: '{count} saved chats',
    newChat: 'New Chat',
    renameConversation: 'Rename chat',
    renamePlaceholder: 'Enter a chat title',
    ...
    autoSwitchedToImageModel: 'Automatically switched to image generation with {model}.',
    noImageModelAvailable: 'No image generation model is available in the current group.',
    imageGenerationEmpty: 'Image generation completed, but no displayable image was returned.',
    emptyReply: 'The model returned an empty reply.',
    emptyPreview: 'No messages yet',
    emptyEditError: 'Message content cannot be empty',
    ...
    editMessageHint: 'Press Enter to save and resend, Shift + Enter for a new line',
    editingMessage: 'You are editing a previous message. Saving will regenerate the reply from that point.',
    saveAndResend: 'Save and resend',
    regenerate: 'Regenerate',
    localHistoryNotice: 'Chat history stays in this browser tab and is not synced to the server automatically.',
    streamingStatus: 'Generating reply...',
    modelAndGroup: '{group} · {model}',
    attachmentsTitle: 'Attachments',
    openAttachment: 'Open file',
    previewUnavailable: 'This file cannot be embedded here yet, but you can open it directly.',
    attachmentKinds: {
      pdf: 'PDF',
      presentation: 'PPT',
      document: 'File'
    ...
    attachmentReady: 'Will be sent with the message',
    attachmentPreviewOnly: 'Preview only, not sent to the model',
    previewOnlyContextNotice: 'These attachments stay browser-side for preview only and are not sent as binary content to the model:',
    previewOnlyAttachmentNotice: 'PDF and PPT files are preview-only for now and are not sent to the model as file content.',
    attachmentUnsupported: 'Unsupported attachment: {name}',
    attachmentReadFailed: 'Failed to read attachment: {name}',
    attachmentImageTooLarge: 'Image attachments must be 8MB or smaller.',
    attachmentTextTooLarge: 'Text and markdown attachments must be 2MB or smaller.',
    attachmentPreviewTooLarge: 'Preview attachments must be 20MB or smaller.',
    starters: {
  ...
  auth: {
    ...
    rememberCredentials: 'Save username and password',
    apiServerUrl: 'Server URL',
    apiServerUrlPlaceholder: 'https://example.com or https://example.com/api/v1',
    apiServerUrlHint: 'Saved automatically; a server root URL is completed with /api/v1',
    invalidApiServerUrl: 'Enter a valid HTTPS server URL',
    ...
    federation: {
      callbackTitle: 'Connecting to Managed Node',
      callbackProcessing: 'Signing you in to the target node, please wait...',
      callbackHint: 'If this page does not redirect automatically, go back and try the jump action again.',
      callbackMissingToken: 'Missing federation login token, please try again.',
      backToLogin: 'Back to Login'
    },
    oauthFlow: {
  ...
  admin: {
    realtimeVoiceTest: {
      ...
      description: 'Verify the OAuth WebRTC signaling path without relaying audio through the gateway.',
      directMediaNotice: 'The gateway only proxies the SDP handshake. After the connection is established, microphone audio flows directly between this browser and OpenAI.',
      ...
      mode: 'Voice mode',
      advanced: 'Advanced voice (vp)',
      standard: 'Standard voice (vps)',
      wingman: 'Wingman (wm)',
      endpoint: 'Signaling endpoint',
      sessionJson: 'Session JSON',
      sessionJsonHint: 'This object is forwarded as the multipart session field. Adjust it when ChatGPT changes its private session schema.',
      ...
      state: {
        ...
        signaling: 'Sending SDP handshake',
      ...
      iceGathering: 'ICE gathering',
      dtlsState: 'DTLS state',
      selectedCandidatePair: 'ICE candidate pair',
      duration: 'Duration',
      mediaPath: 'Media path',
      mediaPathValue: 'Browser ↔ OpenAI (direct)',
      remoteAudio: 'Remote audio',
      remoteAudioHint: 'If autoplay is blocked, use the player controls below.',
      transcript: 'Live transcript',
      transcriptEmpty: 'Transcripts returned by the realtime data channel will appear here.',
      you: 'You',
      assistant: 'Assistant',
      events: 'Realtime event log',
      eventsHint: 'Only the latest 100 events are kept in browser memory.',
      noEvents: 'No events yet.',
      microphoneUnsupported: 'Microphone access requires HTTPS or localhost and a supported browser.',
      apiKeyRequired: 'Enter a gateway API key.',
      invalidSessionJson: 'Session JSON must be a valid JSON object.',
      emptySdpAnswer: 'The upstream returned an empty SDP answer.',
      requestFailed: 'Realtime signaling failed.',
      microphoneDenied: 'Microphone access failed. Check the browser permission and retry.',
      peerConnectionFailed: 'The WebRTC connection failed. Microphone and connection resources were released automatically.'
    },
    // Dashboard
    dashboard: {
    ...
    users: {
      ...
      importKeyTitle: 'Import User API Key',
      importKeyTarget: 'Target user',
      importKeyNameLabel: 'Name',
      importKeyNamePlaceholder: 'Enter a name, or leave blank to auto-generate',
      importKeyNameHint: 'You can customize the display name. Leave it blank to use the default generated name.',
      importKeyInputLabel: 'API Key',
      importKeyPlaceholder: 'Enter the key to import',
      importKeyHint: 'Letters, numbers, underscores, and hyphens only, minimum 16 characters.',
      importKeyRequired: 'Please enter a key to import',
      importKeyTooShort: 'Key must be at least 16 characters long',
      importKeyInvalidChars: 'Key can only contain letters, numbers, underscores, and hyphens',
      importKeyExists: 'This key already exists',
      importKeyRateLimited: 'Too many import attempts. Please try again later',
      importingKey: 'Importing...',
      confirmImportKey: 'Import Key',
      importKeySuccess: 'Key imported successfully',
      importKeyFailed: 'Failed to import key',
      transferKey: 'Transfer Key',
      transferKeyTitle: 'Transfer API Key',
      transferKeyNameLabel: 'Key name after transfer',
      transferKeyNamePlaceholder: 'Enter the key name after transfer',
      transferKeyNameHint: 'Defaults to the first non-empty value among the original key name, user notes, username, and user account. You can edit it before transfer.',
      transferKeyNameRequired: 'Please enter the key name after transfer',
      transferKeyNameInvalid: 'Key name cannot exceed 100 characters',
      transferKeyTargetLabel: 'Target user',
      transferKeyTargetPlaceholder: 'Search by username or email',
      transferKeyTargetHint: 'Search for and select the user who will receive this key.',
      transferKeyNoUsers: 'No matching users found',
      transferKeyGroupLabel: 'Target group',
      transferKeyGroupHint: 'Group options come from the target user\'s currently active subscriptions. Choose no group to clear this key group binding after transfer.',
      transferKeyGroupsLoading: 'Loading the target user\'s active subscription groups...',
      transferKeySelectUserFirst: 'Select a target user to view available subscription groups',
      transferKeyNoValidSubscriptionGroups: 'This user has no active subscription groups',
      transferKeyGroupLoadFailed: 'Failed to load the target user\'s subscription groups',
      transferKeyTargetRequired: 'Please select a target user',
      transferKeyTargetSame: 'Target user cannot be the current user',
      transferKeyUserNotFound: 'Target user does not exist',
      transferKeyUserNotActive: 'Target user is not active',
      transferKeyGroupInvalid: 'Target group is invalid',
      transferKeyGroupNotActive: 'Target group is not active',
      transferKeySubscriptionRequired: 'Target user does not have an active subscription for this group',
      transferringKey: 'Transferring...',
      confirmTransferKey: 'Transfer Key',
      transferKeySuccess: 'Key transferred successfully',
      transferKeySuccessWithGrant: 'Key transferred. Target user auto-granted access to "{group}"',
      transferKeyFailed: 'Failed to transfer key',
    ...
    subscriptions: {
      ...
      resetQuotaConfirm: "Select which usage quota periods to reset for '{user}'. Selected usage will be zeroed and windows restarted from today.",
      resetQuotaPeriods: 'Reset periods',
      resetQuotaDaily: 'Day',
      resetQuotaWeekly: 'Week',
      resetQuotaMonthly: 'Month',
      selectResetQuotaPeriod: 'Select at least one reset period',
      quotaResetSuccess: 'Quota reset successfully',
      failedToResetQuota: 'Failed to reset quota',
    ...
    usage: {
      ...
      searchConversationPlaceholder: 'Fuzzy search conversation ID...',
      requestId: 'Request ID',
      searchRequestPlaceholder: 'Fuzzy search request ID...',
      requestAndConversation: 'Conversation / Request ID',
      ...
      rankingSortCost: 'Cost',
      apiKeyPrefix: 'API Key #{id}',
      unknownApiKey: 'Unknown API Key',
      periodShare: 'Period Share',
      tokenShareShort: 'Tokens',
      costShareShort: 'Cost',
      cleanup: {
        button: 'Cleanup',
    ...
    settings: {
      ...
      managedNodeKeys: {
        title: 'Managed Node Keys',
        description: 'Dedicated admin keys for cross-node management. Keys can be created, revoked, and audited.',
        name: 'Key Name',
        namePlaceholder: 'Example: Node A federation key',
        descriptionLabel: 'Description',
        descriptionPlaceholder: 'Optional notes about which node or system uses this key',
        create: 'Create Key',
        creating: 'Creating...',
        empty: 'No managed node keys yet',
        keyGenerated: 'Managed node key generated',
        keyRevoked: 'Managed node key revoked',
        keyCopied: 'Managed node key copied',
        keyWarning: 'New key for {name}. This key will only be shown once.',
        copyKey: 'Copy Key',
        usage: 'Use this key in x-api-key when another node manages this node.',
        statusActive: 'Active',
        ...
        revokedAt: 'Revoked',
        revoke: 'Revoke',
        revokeConfirm: 'Revoke managed node key "{name}"?',
        revokeReasonPrompt: 'Optional revoke reason',
        viewAudit: 'View Audit',
        hideAudit: 'Hide Audit',
        auditTitle: 'Audit Records',
        auditEmpty: 'No audit records yet',
        auditActionCreated: 'Created',
        auditActionUsed: 'Used',
        auditActionRevoked: 'Revoked',
        auditCreated: 'Key created',
      ...
      managedNodes: {
        title: 'Managed Nodes',
        description: 'Store remote node addresses and managed-node keys, test connectivity, and jump into the target admin dashboard without entering a password.',
        name: 'Node Name',
        namePlaceholder: 'Example: Node B',
        scheme: 'Protocol',
        host: 'Host / IP',
        hostPlaceholder: 'example.com or 10.0.0.12',
        port: 'Port',
        portPlaceholder: '8080',
        apiKey: 'Managed Node Key',
        apiKeyOptional: 'Managed Node Key (optional)',
        apiKeyPlaceholder: 'mnode-xxxxxxxxxxxxxxxx',
        apiKeyKeepPlaceholder: 'Leave empty to keep the current key',
        descriptionLabel: 'Description',
        descriptionPlaceholder: 'Optional notes for this target node',
        create: 'Add Node',
        update: 'Save Changes',
        saving: 'Saving...',
        empty: 'No managed nodes configured yet',
        created: 'Managed node added',
        updated: 'Managed node updated',
        deleted: 'Managed node deleted',
        deleteConfirm: 'Delete managed node "{name}"?',
        jump: 'Jump',
        jumpFailed: 'Failed to generate the jump link',
        popupBlocked: 'Popup was blocked by the browser',
        test: 'Test',
        testFailed: 'Managed node connection test failed',
        testSuccess: 'Connected to {siteName}',
        createdAt: 'Created',
        updatedAt: 'Updated',
        ...
        hostRequired: 'Please enter a host or IP',
        apiKeyRequired: 'Please enter the managed node key'
      },
      soraS3: {
        title: 'Sora Storage',
