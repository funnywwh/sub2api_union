export default {
  ...
  chat: {
    ...
    workspace: '会话空间',
    historyTitle: '聊天记录',
    historySubtitle: '像 ChatGPT 一样在左侧管理当前标签页里的对话历史。',
    sessionCount: '已保存 {count} 个会话',
    newChat: '新建会话',
    renameConversation: '重命名会话',
    renamePlaceholder: '输入会话名称',
    collapseHistory: '收起会话栏',
    expandHistory: '展开会话栏',
    openHistory: '打开会话栏',
    closeHistory: '关闭会话栏',
    groupLabel: '分组',
    ...
    autoSwitchedToImageModel: '已自动切换到图片模型生成：{model}',
    noImageModelAvailable: '当前分组没有可用的图片生成模型。',
    imageGenerationEmpty: '图片生成成功，但没有返回可展示的图片。',
    emptyReply: '模型返回了空内容。',
    emptyPreview: '还没有消息',
    emptyEditError: '消息内容不能为空',
    emptyTitle: '这次想聊点什么？',
    ...
    copyMessage: '复制消息',
    editMessage: '编辑消息',
    editMessageHint: '回车保存并重新发送，Shift + 回车换行',
    editingMessage: '你正在编辑一条此前的消息，保存后会从这里重新生成回复。',
    saveAndResend: '保存并重发',
    regenerate: '重新生成',
    localHistoryNotice: '聊天记录仅保存在当前浏览器标签页，不会自动同步到服务器。',
    streamingStatus: '正在生成回复...',
    modelAndGroup: '{group} · {model}',
    attachmentsTitle: '附件预览',
    openAttachment: '打开附件',
    previewUnavailable: '当前文件暂时无法内嵌预览，但可以直接打开。',
    attachmentKinds: {
      pdf: 'PDF',
      presentation: 'PPT',
      document: '文件'
    ...
    attachmentReady: '会随消息一起发送',
    attachmentPreviewOnly: '仅本地预览，不会传给模型',
    previewOnlyContextNotice: '以下附件仅在浏览器中预览，二进制内容不会发送给模型：',
    previewOnlyAttachmentNotice: 'PDF / PPT 当前只做本地预览，不会把文件内容直接发给模型。',
    attachmentUnsupported: '暂不支持附件：{name}',
    attachmentReadFailed: '读取附件失败：{name}',
    attachmentImageTooLarge: '图片附件过大，请控制在 8MB 以内。',
    attachmentTextTooLarge: '文本或 Markdown 附件过大，请控制在 2MB 以内。',
    attachmentPreviewTooLarge: '预览附件过大，请控制在 20MB 以内。',
    starters: {
      debug: '帮我排查这段代码的问题',
      summary: '总结最近的架构决策',
      plan: '给我一个可执行的实现计划'
  ...
  auth: {
    ...
    continue: '继续',
    rememberMe: '记住我',
    rememberCredentials: '保存用户名和密码',
    apiServerUrl: '服务器地址',
    apiServerUrlPlaceholder: 'https://example.com 或 https://example.com/api/v1',
    apiServerUrlHint: '自动保存；输入服务器根地址时会自动补全 /api/v1',
    invalidApiServerUrl: '请输入有效的 HTTPS 服务器地址',
    ...
    federation: {
      callbackTitle: '正在连接受管节点',
      callbackProcessing: '正在为你登录目标节点，请稍候...',
      callbackHint: '如果页面没有自动跳转，请返回上一页后重新执行跳转。',
      callbackMissingToken: '缺少联邦登录令牌，请重新发起跳转。',
      backToLogin: '返回登录'
    },
    oauthFlow: {
  ...
  admin: {
    realtimeVoiceTest: {
      title: '实时语音测试',
      description: '验证 OAuth WebRTC 信令链路，音频不经过网关中转。',
      directMediaNotice: '网关只代理一次 SDP 握手；连接建立后，麦克风音频在当前浏览器与 OpenAI 之间直连。',
      configuration: '测试配置',
      apiKey: '网关 API Key',
      ...
      sessionJsonHint: '该对象会作为 multipart 的 session 字段转发；ChatGPT 私有会话结构变化时可在这里调整。',
      resetTemplate: '恢复模板',
      start: '开始测试',
      starting: '连接中...',
      stop: '停止',
      ...
      iceConnection: 'ICE 连接',
      signalingState: '信令状态',
      iceGathering: 'ICE 收集',
      dtlsState: 'DTLS 状态',
      selectedCandidatePair: 'ICE 候选对',
      duration: '持续时间',
      mediaPath: '媒体路径',
      mediaPathValue: '浏览器 ↔ OpenAI（直连）',
      remoteAudio: '远端音频',
      remoteAudioHint: '如果浏览器阻止自动播放，请使用下方播放器按钮。',
      transcript: '实时转写',
      transcriptEmpty: 'Realtime 数据通道返回的转写内容会显示在这里。',
      you: '你',
      assistant: '助手',
      events: 'Realtime 事件日志',
      eventsHint: '浏览器内存中只保留最近 100 条事件。',
      noEvents: '暂无事件。',
      microphoneUnsupported: '麦克风访问需要 HTTPS 或 localhost，并使用支持 WebRTC 的浏览器。',
      apiKeyRequired: '请输入网关 API Key。',
      invalidSessionJson: 'Session JSON 必须是有效的 JSON 对象。',
      emptySdpAnswer: '上游返回了空的 SDP Answer。',
      requestFailed: 'Realtime 信令请求失败。',
      microphoneDenied: '无法访问麦克风，请检查浏览器权限后重试。',
      peerConnectionFailed: 'WebRTC 连接失败，麦克风和连接资源已自动释放。'
    },
    // Dashboard
    dashboard: {
      title: '管理控制台',
    ...
    users: {
      ...
      apiKeys: 'API密钥',
      importKey: '导入Key',
      importKeyTitle: '导入用户 API 密钥',
      importKeyTarget: '目标用户',
      importKeyNameLabel: '名称',
      importKeyNamePlaceholder: '请输入名称，不填则自动生成',
      importKeyNameHint: '可自定义显示名称；留空时会自动按 Key 生成默认名称',
      importKeyInputLabel: 'API Key',
      importKeyPlaceholder: '请输入要导入的 Key',
      importKeyHint: '仅支持字母、数字、下划线和连字符，至少 16 位',
      importKeyRequired: '请输入要导入的 Key',
      importKeyTooShort: 'Key 长度不能少于 16 位',
      importKeyInvalidChars: 'Key 只能包含字母、数字、下划线和连字符',
      importKeyExists: '该 Key 已存在',
      importKeyRateLimited: '导入尝试过于频繁，请稍后再试',
      importingKey: '导入中...',
      confirmImportKey: '确认导入',
      importKeySuccess: 'Key 导入成功',
      importKeyFailed: 'Key 导入失败',
      transferKey: '转让Key',
      transferKeyTitle: '转让 API Key',
      transferKeyNameLabel: '转让后 Key 名称',
      transferKeyNamePlaceholder: '请输入转让后的 Key 名称',
      transferKeyNameHint: '默认按 Key 原名、用户备注、用户名、用户账号依次取第一个非空值，可在转让前修改',
      transferKeyNameRequired: '请输入转让后的 Key 名称',
      transferKeyNameInvalid: 'Key 名称不能超过 100 个字符',
      transferKeyTargetLabel: '目标用户',
      transferKeyTargetPlaceholder: '输入用户名或邮箱搜索',
      transferKeyTargetHint: '先搜索并选择要接收此 Key 的用户',
      transferKeyNoUsers: '未找到匹配用户',
      transferKeyGroupLabel: '目标分组',
      transferKeyGroupHint: '分组列表来自目标用户当前有效订阅；选择无分组则转让后清空此 Key 的分组绑定',
      transferKeyGroupsLoading: '正在加载目标用户的有效订阅分组...',
      transferKeySelectUserFirst: '请选择目标用户后查看可用订阅分组',
      transferKeyNoValidSubscriptionGroups: '该用户暂无有效订阅分组',
      transferKeyGroupLoadFailed: '加载目标用户订阅分组失败',
      transferKeyTargetRequired: '请选择目标用户',
      transferKeyTargetSame: '目标用户不能是当前用户',
      transferKeyUserNotFound: '目标用户不存在',
      transferKeyUserNotActive: '目标用户未启用',
      transferKeyGroupInvalid: '目标分组无效',
      transferKeyGroupNotActive: '目标分组未启用',
      transferKeySubscriptionRequired: '目标用户没有该订阅分组的有效订阅',
      transferringKey: '转让中...',
      confirmTransferKey: '确认转让',
      transferKeySuccess: 'Key 转让成功',
      transferKeySuccessWithGrant: 'Key 转让成功，已自动为目标用户添加「{group}」分组权限',
      transferKeyFailed: 'Key 转让失败',
    ...
    subscriptions: {
      ...
      resetQuotaConfirm: "请选择要重置 '{user}' 的用量配额周期。选中的用量将归零并从今天开始重新计算。",
      resetQuotaPeriods: '重置周期',
      resetQuotaDaily: '日',
      resetQuotaWeekly: '周',
      resetQuotaMonthly: '月',
      selectResetQuotaPeriod: '请至少选择一个重置周期',
    ...
    usage: {
      ...
      group: '分组',
      conversationId: '会话ID',
      searchConversationPlaceholder: '模糊搜索会话ID...',
      requestId: '请求ID',
      searchRequestPlaceholder: '模糊搜索请求ID...',
      requestAndConversation: '会话 / 请求ID',
    ...
    settings: {
      ...
      managedNodeKeys: {
        title: '受管节点 Keys',
        description: '用于节点间互管的专用管理员密钥，支持新建、作废和审计查看。',
        name: '密钥名称',
        namePlaceholder: '例如：节点 A 联邦管理密钥',
        descriptionLabel: '描述',
        descriptionPlaceholder: '可选，用于说明哪个节点或系统在使用这把 key',
        create: '创建密钥',
        creating: '创建中...',
        empty: '还没有受管节点密钥',
        keyGenerated: '受管节点密钥已生成',
        keyRevoked: '受管节点密钥已作废',
        keyCopied: '受管节点密钥已复制',
        keyWarning: '{name} 的新密钥已生成，此密钥只会显示一次。',
        copyKey: '复制密钥',
        usage: '其他节点管理当前节点时，可在 x-api-key 中使用此密钥。',
        statusActive: '生效中',
        statusRevoked: '已作废',
        createdAt: '创建时间',
        lastUsedAt: '最后使用',
        ...
        revokedAt: '作废时间',
        revoke: '作废',
        revokeConfirm: '确定要作废受管节点密钥“{name}”吗？',
        revokeReasonPrompt: '可选：输入作废原因',
        viewAudit: '查看审计',
        hideAudit: '收起审计',
        auditTitle: '审计记录',
        auditEmpty: '暂无审计记录',
        auditActionCreated: '已创建',
        auditActionUsed: '已使用',
        auditActionRevoked: '已作废',
        auditCreated: '密钥已创建',
        noReason: '未填写原因',
        operator: '操作人',
      ...
      managedNodes: {
        title: '受管节点',
        description: '保存目标节点地址和受管节点密钥，支持测试连接，并可一键免密跳转到目标节点后台。',
        name: '节点名称',
        namePlaceholder: '例如：节点 B',
        scheme: '协议',
        host: '主机 / IP',
        hostPlaceholder: 'example.com 或 10.0.0.12',
        port: '端口',
        portPlaceholder: '8080',
        apiKey: '受管节点密钥',
        apiKeyOptional: '受管节点密钥（可选）',
        apiKeyPlaceholder: 'mnode-xxxxxxxxxxxxxxxx',
        apiKeyKeepPlaceholder: '留空则保持当前密钥',
        descriptionLabel: '说明',
        descriptionPlaceholder: '可选备注，说明该目标节点用途',
        create: '添加节点',
        update: '保存修改',
        saving: '保存中...',
        empty: '还没有配置受管节点',
        ...
        updated: '受管节点已更新',
        deleted: '受管节点已删除',
        deleteConfirm: '确定删除受管节点“{name}”吗？',
        jump: '跳转',
        jumpFailed: '生成跳转链接失败',
        popupBlocked: '浏览器拦截了新窗口，请允许弹窗后重试',
        test: '测试',
        testFailed: '受管节点连接测试失败',
        testSuccess: '已连接到 {siteName}',
        createdAt: '创建时间',
        updatedAt: '更新时间',
        remoteSite: '远端站点',
        remoteAuth: '远端认证方式',
        remoteFrontend: '远端前端地址',
        nameRequired: '请输入节点名称',
        hostRequired: '请输入主机或 IP',
        apiKeyRequired: '请输入受管节点密钥'
      },
      soraS3: {
        title: 'Sora 存储配置',
