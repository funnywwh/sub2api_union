...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'happyhorse'
...
const BADGE: Record<Platform, string> = {
  ...
  happyhorse: 'bg-pink-500/10 text-pink-600 border-pink-500/30 dark:text-pink-400',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  happyhorse: 'bg-pink-500/10 text-pink-600 dark:bg-pink-500/10 dark:text-pink-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  happyhorse: 'border-pink-500/20 dark:border-pink-500/20',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  happyhorse: 'bg-gradient-to-r from-pink-400 to-pink-500',
}
...
const TEXT: Record<Platform, string> = {
  ...
  happyhorse: 'text-pink-600 dark:text-pink-400',
}
...
const ICON: Record<Platform, string> = {
  ...
  happyhorse: 'text-pink-500 dark:text-pink-400',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  happyhorse: 'bg-pink-500 text-white hover:bg-pink-600 active:bg-pink-700 dark:bg-pink-500/80 dark:hover:bg-pink-500',
}
...
const DISCOUNT: Record<Platform, string> = {
  ...
  happyhorse: 'bg-pink-100 text-pink-700 dark:bg-pink-900/40 dark:text-pink-300',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  happyhorse: 'from-pink-500 to-pink-600',
}
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'happyhorse'
}
...
export function platformLabel(p: string): string {
  switch (p) {
    ...
    case 'happyhorse': return 'HappyHorse'
