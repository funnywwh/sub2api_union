...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "conversation_id", Type: field.TypeString, Nullable: true, Size: 255},
		...
		{Name: "audio_duration_ms", Type: field.TypeInt, Nullable: true},
		{Name: "hourly_price", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
