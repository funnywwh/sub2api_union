...
type UsageLog struct {
	...
	// AudioDurationMs holds the value of the "audio_duration_ms" field.
	AudioDurationMs *int `json:"audio_duration_ms,omitempty"`
	// HourlyPrice holds the value of the "hourly_price" field.
...
func (*UsageLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usagelog.FieldInputCost, usagelog.FieldOutputCost, usagelog.FieldCacheCreationCost, usagelog.FieldCacheReadCost, usagelog.FieldTotalCost, usagelog.FieldActualCost, usagelog.FieldRateMultiplier, usagelog.FieldAccountRateMultiplier, usagelog.FieldHourlyPrice:
			values[i] = new(sql.NullFloat64)
		case usagelog.FieldID, usagelog.FieldUserID, usagelog.FieldAPIKeyID, usagelog.FieldAccountID, usagelog.FieldChannelID, usagelog.FieldGroupID, usagelog.FieldSubscriptionID, usagelog.FieldInputTokens, usagelog.FieldOutputTokens, usagelog.FieldCacheCreationTokens, usagelog.FieldCacheReadTokens, usagelog.FieldCacheCreation5mTokens, usagelog.FieldCacheCreation1hTokens, usagelog.FieldBillingType, usagelog.FieldDurationMs, usagelog.FieldAudioDurationMs, usagelog.FieldFirstTokenMs, usagelog.FieldImageCount:
			values[i] = new(sql.NullInt64)
		case usagelog.FieldRequestID, usagelog.FieldConversationID, usagelog.FieldModel, usagelog.FieldRequestedModel, usagelog.FieldUpstreamModel, usagelog.FieldModelMappingChain, usagelog.FieldBillingTier, usagelog.FieldBillingMode, usagelog.FieldUserAgent, usagelog.FieldIPAddress, usagelog.FieldImageSize:
	...
	for i := range columns {
		...
		case usagelog.FieldAudioDurationMs:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				_m.AudioDurationMs = new(int)
				*_m.AudioDurationMs = int(value.Int64)
			}
		case usagelog.FieldHourlyPrice:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field hourly_price", values[i])
			} else if value.Valid {
				_m.HourlyPrice = new(float64)
				*_m.HourlyPrice = value.Float64
			}
...
func (_m *UsageLog) String() string {
	...
	builder.WriteString(", ")
	if v := _m.AudioDurationMs; v != nil {
		builder.WriteString("audio_duration_ms=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
	if v := _m.HourlyPrice; v != nil {
		builder.WriteString("hourly_price=")
		builder.WriteString(fmt.Sprintf("%v", *v))
	}
	builder.WriteString(", ")
