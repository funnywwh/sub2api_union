...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	managedNodeAPIKeyRepository := repository.NewManagedNodeAPIKeyRepository(db)
	managedNodeAPIKeyService := service.NewManagedNodeAPIKeyService(managedNodeAPIKeyRepository)
	...
	happyHorseTaskRepository := repository.NewHappyHorseTaskRepository(db)
	...
	happyHorseGatewayService := service.NewHappyHorseGatewayService(accountRepository, happyHorseTaskRepository, httpUpstream, configConfig)
	...
	settingHandler := admin.NewSettingHandler(settingService, managedNodeAPIKeyService, managedNodeService, emailService, turnstileService, opsService, paymentConfigService, paymentService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, userChatHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, happyHorseGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, idempotencyCoordinator, idempotencyCleanupService)
	jwtAuthMiddleware := middleware.NewJWTAuthMiddleware(authService, userService)
	adminAuthMiddleware := middleware.NewAdminAuthMiddleware(authService, userService, settingService, managedNodeAPIKeyService)
	...
	v := provideCleanup(client, redisClient, opsMetricsCollector, opsAggregationService, opsAlertEvaluatorService, opsCleanupService, opsScheduledReportService, opsSystemLogSink, schedulerSnapshotService, tokenRefreshService, accountExpiryService, subscriptionExpiryService, usageCleanupService, idempotencyCleanupService, pricingService, emailQueueService, billingCacheService, usageRecordWorkerPool, subscriptionService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, openAIGatewayService, openAIGatewayHandler, timingWheelService, scheduledTestRunnerService, backupService, paymentOrderExpiryService, channelMonitorRunner)
