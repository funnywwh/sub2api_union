...
const DefaultCSPPolicy = "default-src 'self'; script-src 'self' __CSP_NONCE__ https://challenges.cloudflare.com https://static.cloudflareinsights.com https://*.stripe.com https://cdn.jsdelivr.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https: blob:; font-src 'self' data: https://fonts.gstatic.com; connect-src 'self' https: blob:; worker-src 'self' blob: https://cdn.jsdelivr.net; frame-src 'self' blob: https://challenges.cloudflare.com https://*.stripe.com https://view.officeapps.live.com; frame-ancestors 'none'; base-uri 'self'; form-action 'self'"
